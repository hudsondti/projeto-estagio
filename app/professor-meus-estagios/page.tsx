...
import { OrientadosCard } from "../professor-inicio/components/OrientadosCard";
import ConfirmacoesCard from "./components/ConfirmacoesCard";
  ...
  return (
    <section className="">
      ...
      <div className="py-[100px]">
        {currentView === "Estagios" && <OrientadosCard />}
        {currentView === "Confirmacoes" && <ConfirmacoesCard />}
      </div>
    </section>
  );
}
